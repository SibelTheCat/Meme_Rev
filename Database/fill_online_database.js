...
con.connect(function(err) {
    ...
    var values = [
         ['daily_cat_facts', 'pickle kitty', 'pics/PickleCat.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty', 'pics/cat2.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty','pics/cat4.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty', 'pics/cat3.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty', 'pics/cat5.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty', 'pics/cat6.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty','pics/cat7.jpg', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
         ['daily_cat_facts', 'pickle kitty','pics/cat8.png', 'everybody loves grumpy cat', 'cat', 'grumpy', ' love', 0],
     ]
  /*  var values = [
